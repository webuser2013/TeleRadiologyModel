...
-- SEQUENCE: public."RadCenterSequence"

-- DROP SEQUENCE public."RadCenterSequence";

CREATE SEQUENCE public."RadCenterSequence"
    INCREMENT 1
    START 1
    MINVALUE 1
    MAXVALUE 9223372036854775807
...
ALTER SEQUENCE public."RadCenterSequence"
    OWNER TO postgres;	
...
(
    ...
    "ServerRam" numeric,
    "ServerCoreCount" numeric,
    "ServerStorage" numeric,
...
INSERT INTO public."Users"("UserId", "Name", "EmailId", "Password", "MobileNumber", "AlternativeMobileNumber", "Address", "Pincode", "RoleId", "CreatedDate", "CreatedTime", "ModifiedDate", "ModifiedTime", "CreatedIpAddress", "ModifiedIpAddress", "PrivilegeCd") VALUES (1,'Saravanan ram','skram90@gmail.com','21232f297a57a5a743894a0e4a801fc3','9976944364',null,'test address','600100',1, CURRENT_DATE,CURRENT_TIMESTAMP,CURRENT_DATE,CURRENT_TIMESTAMP,'000.000.000.000','000.000.000.000',1);
